...
export const ui = {
	de: {
		...
		'nav.contact': `Kontakt`,
		'header.title': `Timeless Wedding Photography & Cinematic Wedding Film`,
		'header.subtitle': ``,
		'header.work-in-progress-1': `Wir sind im Kreativmodus!`,
		'header.work-in-progress-2': `Wir feilen am Design und bereiten neue Shootings zum Teilen vor.`,
		'header.work-in-progress-3': `Spannende Updates folgen in Kürze...`,
		'about.title': `Ein bisschen über mich`,
		'about.figcaption': `Hallo! Ich bin Manuel`,
	...
	en: {
		...
		'header.title': `Timeless Wedding Photography & Cinematic Wedding Film`,
		'header.subtitle': ``,
		'header.work-in-progress-1': `We’re in creation mode!`,
		'header.work-in-progress-2': `Polishing the design and preparing new shoots to share.`,
		'header.work-in-progress-3': `Exciting updates are coming soon...`,
		'about.title': `A little something about me`,
		'about.figcaption': `Hi! I'm Manuel`,
	...
	es: {
		...
		'header.title': `Timeless Wedding Photography & Cinematic Wedding Film`,
		'header.subtitle': ``,
		'header.work-in-progress-1': `¡Estamos en modo creación!`,
		'header.work-in-progress-2': `Puliendo el diseño y preparando nuevas sesiones para compartir.`,
		'header.work-in-progress-3': `Próximas actualizaciones emocionantes...`,
		'about.title': `Un poco sobre mí`,
		'about.figcaption': `Hola! Soy Manuel`,
	...
	fr: {
		...
		'header.title': `Timeless Wedding Photography & Cinematic Wedding Film`,
		'header.subtitle': ``,
		'header.work-in-progress-1': `Nous sommes en phase de création !`,
		'header.work-in-progress-2': `Nous peaufinons le design et préparons de nouvelles séances à partager.`,
		'header.work-in-progress-3': `Des nouveautés passionnantes arrivent bientôt...`,
		'about.title': `Quelques mots à mon sujet`,
		'about.figcaption': `Bonjour! Je suis Manuel`,
